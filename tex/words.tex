...
\newword{Unspent Transaction Output (UTXO)}{Unspent Transaction Output (UTXO)}{خروجی خرج نشده تراکنش}{خروجی خرج نشده تراکنش}
...
\newword{Script}{Script}{نبشته}{نبشته}
\newword{Denial of Service Attack}{Denial of Service Attack}{حملهٔ منع خدمت}{حملهٔ منع خدمت}
...
\newword{High-Granularity Digital Side-Channel Attacks}{High-Granularity Digital Side-Channel Attacks}{ملات کانال جانبی دیجیتال دانه‌بندی زیاد}{}
